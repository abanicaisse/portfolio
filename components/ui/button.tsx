  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        default:
          "bg-white text-black rounded-full hover:bg-[#BFFF0A] transition-all duration-300",
        destructive:
        ...
        link: "text-[#BFFF0A] hover:underline underline-offset-4 hover:bg-transparent",

        // Icon button variants
        icon: "rounded-full bg-white text-black hover:bg-[#BFFF0A] transition-colors",
        "icon-outline":
